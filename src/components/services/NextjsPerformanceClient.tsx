            ...
            <section className="border-b border-white/5 px-4 py-16">
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="mt-6 flex flex-wrap gap-3">
                        ...
                        <Link href="/blog/reducing-latency-without-rewrites" className="rounded-full border border-white/15 px-4 py-2 text-sm text-zinc-300 hover:bg-white/5 hover:text-white">
                            Reducing Latency Without Rewrites
                        </Link>
                    </div>
                </div>
            </section>
