            ...
            {!hideIntro && (
                <div className="flex flex-col items-center gap-4 text-center z-10 mb-6 md:mb-12">
                    ...
                    <p className="text-zinc-400 max-w-lg">
                        <span className="font-semibold text-white">Examples of the work I do most: SaaS MVP builds, performance fixes, and production-grade system improvements.</span>
                        <br />
                        Most client work is under NDA. Full details are shared during calls.
                    </p>
                </div>
            )}
...
const data = [
    ...
    {
        category: "Fintech ops team • AI billing workflow",
        ...
        content: <ProjectDetail
            ...
            description="Built an invoice automation system integrated with Slack and Notion to reduce manual billing effort and speed up the finance workflow."
    ...
    {
        category: "Tech media product • Frontend lead",
        title: "High-performance AI tools directory",
    ...
    {
        category: "DevTools startup • Full-stack engineer",
    ...
    {
        category: "Digital asset platform • Performance engineering",
