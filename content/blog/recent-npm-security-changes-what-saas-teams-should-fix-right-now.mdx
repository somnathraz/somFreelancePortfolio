...
## The npm Security Series

This is part of an ongoing series on supply-chain risk for SaaS teams:

- [The April 2026 npm Supply Chain Wave: 48-Hour Checklist](/blog/npm-supply-chain-attacks-april-2026-saas-checklist) — the coordinated attacks that followed these changes
- [Shai-Hulud 2.0: The npm Worm Spreading Through SAP and Intercom Packages](/blog/shai-hulud-2-npm-worm-saas-defense) — self-propagating worm using preinstall hooks
- [TanStack Was Compromised: What SaaS Teams Need to Do](/blog/tanstack-npm-compromise-2026) — the most recent major package compromise
