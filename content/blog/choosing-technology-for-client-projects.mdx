...
metaTitle: "How I Choose SaaS Tech for Clients (And When I Say No)"
description: "How I select technology for client projects — based on business stage, risk, and long-term maintenance cost, not trends. Including when I say no to a stack."
date: "2026-01-22"
readTime: "3 min read"
...
- [Why I Prefer Boring Architecture for SaaS](/blog/boring-architecture-for-saas) — the philosophy behind keeping stacks predictable
- [How I Take a SaaS Idea From Concept to Production](/blog/from-saas-idea-to-production) — how these decisions unfold across a real build
- [When a Founder Needs a Technical Partner](/blog/when-a-founder-needs-a-technical-partner) — the fuller picture of what technical judgment looks like
- [How Much Should a SaaS MVP Cost in 2026?](/blog/saas-mvp-cost-2026) — how technology choices directly affect budget
